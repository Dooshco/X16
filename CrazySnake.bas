...
560 GOSUB 3000
570 GOSUB 4000
580 TM=TM+1:VPOKE 1,$B000+112+INT(TM/250)*2,$60
...
3120 VPOKE 1,$B000+Y%(H%)*256+X%(H%)*2+1,$67
3130 PRINT CHR$(19);
...
3550 VPOKE 1,$B000+HY%*256+HX%*2+1,$68
3560 RETURN
3999 REM
4000 REM ===== DRAW SNAKE =====
4001 REM
...
6001 REM
6010 SCREEN 0:COLOR 7:CLS
6020 FOR X=0 TO 79:VPOKE 1,$B000+X*2+1,$BE:VPOKE 1,$B000+X*2,$60
6030 VPOKE 1,$B000+15104+X*2+1,$EB:VPOKE 1,$B000+15104+X*2,$60:NEXT X
6040 FOR Y=0 TO 59:VPOKE 1,$B000+Y*256+1,$BE:VPOKE 1,$B000+Y*256,$60
6050 VPOKE 1,$B000+Y*256+159,$EB:VPOKE 1,$B000+Y*256+158,$60:NEXT Y
6060 VPOKE 1,$B000+158,105
6070 VPOKE 1,$B000+15105,$EB:VPOKE 1,$B000+15104,105
6080 PRINT CHR$(19);
...
6120 FOR X=5 TO 70:VPOKE 1,$B000+X*2+1,$BE:NEXT X
6130 PRINT CHR$(19);
