...
560 GOSUB 3000
570 GOSUB 4000
580 TM=TM+1:PRINT CHR$(19);:VPOKE 0,70+INT(TM/250)*2,$60
...
3120 VPOKE 0,Y%(H%)*256+X%(H%)*2+1,$67
3130 PRINT CHR$(19);
...
3530 IF VPEEK(0,HY%*256+HX%*2)<>32 THEN GOTO 3510
3540 VPOKE 0,HY%*256+HX%*2,83
3550 VPOKE 0,HY%*256+HX%*2+1,$68
3560 RETURN
3999 REM
4000 REM ===== DRAW SNAKE =====
4001 REM
4010 VPOKE 0, Y%(H%)*256+X%(H%)*2,90
4020 VPOKE 0, Y%(H%-1)*256+X%(H%-1)*2,C%(H%-1)
4030 VPOKE 0, Y%(T%)*256+X%(T%)*2,32
4040 RETURN
4999 REM
5000 REM ===== DRAW WHOLE SNAKE =====
5001 REM
5010 FOR N=T% TO H%
5020 VPOKE 0, Y%(N)*256+X%(N)*2,1
5030 NEXT N
5040 RETURN
5499 REM
...
5501 REM
5510 FOR N=T% TO H%
5520 VPOKE 0, Y%(N)*256+X%(N)*2,24
5530 NEXT N
5540 RETURN
5999 REM
6000 REM ===== CLEAR SCREEN =====
6001 REM
6010 SCREEN 2: PRINT CHR$($9E)+CHR$(147)
6020 FOR X=0 TO 79:VPOKE 0,X*2+1,$BE:VPOKE 0,X*2,$60
6030 VPOKE 0,15104+X*2+1,$EB:VPOKE 0,15104+X*2,$60:NEXT X
6040 FOR Y=0 TO 59:VPOKE 0,Y*256+1,$BE:VPOKE 0,Y*256,$60
6050 VPOKE 0,Y*256+159,$EB:VPOKE 0,Y*256+158,$60:NEXT Y
6060 VPOKE 0,158,105
6070 VPOKE 0,15105,$EB:VPOKE 0,15104,105
6080 PRINT CHR$(19);
...
6120 FOR X=5 TO 70:VPOKE 0,X*2+1,$BE:NEXT X
6130 PRINT CHR$(19);
...
9001 REM
9005 PRINT CHR$(158)+CHR$(147):PRINT
...
9305 PRINT "\X1D\X1D        \X1D\X1D\X1D          \X1D\X1D\X1D    \X1D    \X1D\X1D\X1D       \X1D\X1D\X1D\X1D\X1D\X1D       "
