...
;*******************************************************************************
    ...
    lda #%00000011                      ; LINE and VSYNC are active This works with Emulator up until (including) R41
    ;lda #%0000001                       ; Only VSYNC is activated but for some reason triggers LINE interrupt as well but one line too early
    sta IEN
