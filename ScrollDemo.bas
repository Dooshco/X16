...
60 COLOR 6,0:PRINT TAB(14):PRINT "CONTROLS: LEFT,RIGHT,SHIFT"
70 GOSUB 9000
80 HS=0:VS=0
90 VA=0
100 REM ===== DEMO LOOP =====
110 A=JOY(0)
120 IF A AND 2 THEN VPOKE 1,$B000+3618,90:HS=HS+1:IF HS>63 THEN HS=0
130 IF A AND 1 THEN VPOKE 1,$B000+3626,83:HS=HS-1:IF HS<0 THEN HS=63
140 IF A AND $20 THEN VPOKE 1,$B000+4390,65:VA=VA-0.05:IF VA<-2 THEN VA=-2
...
199 VPOKE 1,$B000+3618,32:VPOKE 1,$B000+3626,32:VPOKE 1,$B000+4390,32
200 GOTO 110
...
6210 VPOKE 1,$F000+90*8+0,$00
6220 VPOKE 1,$F000+90*8+1,$40
6230 VPOKE 1,$F000+90*8+2,$88
6240 VPOKE 1,$F000+90*8+3,$25
6250 VPOKE 1,$F000+90*8+4,$4B
6260 VPOKE 1,$F000+90*8+5,$10
6270 VPOKE 1,$F000+90*8+6,$80
6280 VPOKE 1,$F000+90*8+7,$00
6290 VPOKE 1,$F000+83*8+0,$00
6300 VPOKE 1,$F000+83*8+1,$02
6310 VPOKE 1,$F000+83*8+2,$11
6320 VPOKE 1,$F000+83*8+3,$A4
6330 VPOKE 1,$F000+83*8+4,$D2
6340 VPOKE 1,$F000+83*8+5,$08
6350 VPOKE 1,$F000+83*8+6,$01
6360 VPOKE 1,$F000+83*8+7,$00
6370 VPOKE 1,$F000+65*8+0,$7E
6380 VPOKE 1,$F000+65*8+1,$FF
6390 VPOKE 1,$F000+65*8+2,$FF
6400 VPOKE 1,$F000+65*8+3,$5F
6410 VPOKE 1,$F000+65*8+4,$7A
6420 VPOKE 1,$F000+65*8+5,$2E
6430 VPOKE 1,$F000+65*8+6,$35
6440 VPOKE 1,$F000+65*8+7,$48
6450 RETURN
...
9020 READ D,C
9030 VPOKE 1,$B000+3362+Y*256+X*2,D
9040 VPOKE 1,$B000+3362+Y*256+X*2+1,C
9050 NEXT:NEXT
